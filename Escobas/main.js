...
switch (seleccionMaterial) {
    ...
    case materialNatural:
        ...
        break;
    default:
        alert(`Hubo algo mal en su proceso, por favor digite un numero correcto sea 1 o 2`);
        break;
}
...
if(cantidad >= 3 && cantidad <= 30) {
    ...
    alert(`El precio total de su compra es de $${precioTotal}, cantidad total ${cantidad}, Gracias por confiar en nosotros`);
} else {
